...
inline void pushup(val& u,val& l,val& r) {
    u.g00=max3(l.g00+r.g10,l.g00+r.g00,l.g01+r.g00);
    u.g01=max3(l.g00+r.g01,l.g01+r.g01,l.g00+r.g11);
...
i32 main() {
    ...
    _rep(i,1,n) seg.modify(1,i,i,arr[i]);
    while (m--) {
        int i,t;
        read(i,t);
        seg.modify(1,i,i,t);
        auto g=seg.query(1,1,n);
        ans+=max4(g.g00,g.g01,g.g10,g.g11);
    }
    write(ans);
    return 0;
}