...
i32 main() {
    ...
    while (T--) {
        ...
        _rep(i,1,m) {
            ...
            f[i]=min(f[i],solve(i,0));
            if (r) f[i]=min(f[i],solve(i,r-1));
            f[i]=min(f[i],solve(i,r));
            f[i]=min(f[i],solve(i,i-1));
            writesp(f[i]);
        }
        putchar(10);
    }
...
k=2 t1=4 t2=1
(>>> <<<) (>>> <<<) >>>
cost: 4 4 4 4 4 4 4 4 4 4 4 4 4 4 4 (must)
take: 2 2 2 2 2 2 2 2 2 2 2 2 2 2 2 (must)
