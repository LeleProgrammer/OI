...
int main() {
    _rep(i,1,2025) _rep(j,1,2025) if (lcm(i,j)==2025) vec[i].emplace_back(j);
    _rep(i,1,2025) f[1][i]=1;
    _rep(i,2,2025) _rep(j,1,2025) _for(k,vec[j]) f[i][j]=(f[i][j]+f[i-1][k])%mod;
    int ans=0;
    _rep(i,1,2025) ans=(ans+f[2025][i])%mod;
    write(ans);
    return 0;
}