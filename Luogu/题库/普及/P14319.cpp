...
int main() {
    ...
    while (T--) {
        read(n);
        writesp(1),writesp(1),writeln(n); fflush(stdout);
        writesp(2),writesp(1),writeln(n); fflush(stdout);
        int k;
        read(k);
        if (k==n) {
            writesp(1),writesp(1),writeln(n); fflush(stdout);
            ...
            while (l<r) {
                int mid=l+r>>1;
                writesp(2),writesp(l),writeln(mid); fflush(stdout);
                int k;
                read(k);
                if (!k) l=mid+1;
                else r=mid;
            }
            writesp(3),writeln(r); fflush(stdout);
        } else {
            int l=1,r=n;
            while (l<r) {
                int mid=l+r>>1;
