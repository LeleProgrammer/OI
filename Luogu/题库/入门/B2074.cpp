...
int main() {
    read(a),read(b);
    int ans=ksm(a,b);
    if (ans==0) puts("Sunday");
    else if (ans==1) puts("Monday");
    else if (ans==2) puts("Tuesday");
    else if (ans==3) puts("Wednesday");
    else if (ans==4) puts("Thursday");
    else if (ans==5) puts("Friday");
    else puts("Saturday");
    return 0;
}