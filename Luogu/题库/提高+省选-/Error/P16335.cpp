...
struct val {
    ...
    int lu,ld,ru,rd;
    int mx;
    val(): l(0),r(0),lu(0),ld(0),ru(0),rd(0),mx(0) {}
};
...
inline void pushup(val& u,val& l,val& r) {
    if (l.l==0) u=r;
        ...
        int mid=u.l+u.r>>1;
        if (a[mid]<a[mid+1]) {
            chmax(u.mx,l.ru+r.ld);
            if (l.ru==l.r-l.l+1) {
                if ((l.r-l.l+1)&1) u.lu=l.ru+r.ld;
                else u.ld=l.ru+r.ld;
            }
            if (r.ld==r.r-r.l+1) {
                if ((r.r-r.l+1)&1) u.rd=l.ru+r.ld;
                else u.ru=l.ru+r.ld;
            }
        } else if (a[mid]>a[mid+1]) {
            chmax(u.mx,l.rd+r.lu);
            if (l.rd==l.r-l.l+1) {
                if ((l.r-l.l+1)&1) u.ld=l.rd+r.lu;
                else u.lu=l.rd+r.lu;
            }
            if (r.lu==r.r-r.l+1) {
                if ((r.r-r.l+1)&1) u.ru=l.rd+r.lu;
                else u.rd=l.rd+r.lu;
            }
        }
        u.l=l.l,u.r=r.r;
