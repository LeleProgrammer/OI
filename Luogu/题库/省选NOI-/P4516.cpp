...
using namespace IO;
using Graph::e,Graph::h,Graph::ne,Graph::add;
...
inline void dfs(int u,int fa) {
    ...
    _graph(i,u) {
        if (e[i]==fa) continue;
        dfs(e[i],u);
        _rep(p,0,min(sz[u],k)) _rep(q,0,min(sz[e[i]],k-p)) {
            ff[p+q][3]=0;
            ff[p+q][2]=0;
            ff[p+q][1]=0;
            ff[p+q][0]=0;
        ...
        _rep(p,0,min(sz[u],k)) _rep(q,0,min(sz[e[i]],k-p)) {
            ff[p+q][3]=((i64)ff[p+q][3]+(i64)f[u][p][2]*(f[e[i]][q][2]+f[e[i]][q][3])+(i64)f[u][p][3]*((i64)f[e[i]][q][0]+f[e[i]][q][1]+f[e[i]][q][2]+f[e[i]][q][3]))%mod;
            ff[p+q][2]=((i64)ff[p+q][2]+(i64)f[u][p][2]*(f[e[i]][q][0]+f[e[i]][q][1]))%mod;
            ff[p+q][1]=((i64)ff[p+q][1]+(i64)f[u][p][0]*f[e[i]][q][3]+(i64)f[u][p][1]*(f[e[i]][q][1]+f[e[i]][q][3]))%mod;
            ff[p+q][0]=((i64)ff[p+q][0]+(i64)f[u][p][0]*f[e[i]][q][1])%mod;
        }
        _rep(p,0,min(sz[u],k)) _rep(q,0,min(sz[e[i]],k-p)) {
            f[u][p+q][3]=ff[p+q][3];
            f[u][p+q][2]=ff[p+q][2];
