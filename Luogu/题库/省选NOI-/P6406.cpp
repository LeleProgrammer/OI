...
inline void pushdown(int U) {
    ...
    if (u.ta) {
        l.ta=r.ta=u.ta;
        l.a=(i64)u.ta*(l.r-l.l+1)%mod;
        r.a=(i64)u.ta*(r.r-r.l+1)%mod;
        l.ab=(i64)l.b*u.ta%mod;
        r.ab=(i64)r.b*u.ta%mod;
        u.ta=0;
    }
    if (u.tb) {
        l.tb=r.tb=u.tb;
        l.b=(i64)u.tb*(l.r-l.l+1)%mod;
        r.b=(i64)u.tb*(r.r-r.l+1)%mod;
        l.ab=(i64)l.a*u.tb%mod;
        r.ab=(i64)r.a*u.tb%mod;
        u.tb=0;
    }
}
...
inline void modify(int U,int l,int r,const dat& v) {
    if (tr[U].l>=l && tr[U].r<=r) {
        auto &u=tr[U];
        if (v.ta || (!v.ta && !v.tb)) {
            u.ta=v.ta;
            u.a=(i64)v.ta*(u.r-u.l+1)%mod;
            u.ab=(i64)u.b*v.ta%mod;
        }
        if (v.tb || (!v.ta && !v.tb)) {
            u.tb=v.tb;
            u.b=(i64)v.tb*(u.r-u.l+1)%mod;
            u.ab=(i64)u.a*v.tb%mod;
        }
    } else {
        pushdown(U);
        int mid=tr[U].l+tr[U].r>>1;
...
inline int query(int u,int l,int r) {
    if (tr[u].l>=l && tr[u].r<=r) return tr[u].ab;
    int ans=0;
    int mid=tr[u].l+tr[u].r>>1;
...
int main() {
    ...
    build(1,1,n);
    _rep(i,1,n) {
        while (!smn.empty() && a[smn.top()]>=a[i]) smn.pop();
        while (!smx.empty() && a[smx.top()]<=a[i]) smx.pop();
        int p=1,q=1;
        if (!smn.empty()) p=smn.top()+1;
        if (!smx.empty()) q=smx.top()+1;
        modify(1,p,i,dat{a[i],0});
        modify(1,q,i,dat{0,a[i]});
        smn.emplace(i);
        smx.emplace(i);
        ans=((i64)ans+(i64)query(1,1,i)*(i+1))%mod;
    }
    _rep(i,1,n) modify(1,i,i,dat{0,0});
    while (!smn.empty()) smn.pop();
    while (!smx.empty()) smx.pop();
    _rrep(i,n,1) {
        while (!smn.empty() && a[smn.top()]>=a[i]) smn.pop();
        while (!smx.empty() && a[smx.top()]<=a[i]) smx.pop();
        int p=n,q=n;
        if (!smn.empty()) p=smn.top()-1;
        if (!smx.empty()) q=smx.top()-1;
        modify(1,i,p,dat{a[i],0});
        modify(1,i,q,dat{0,a[i]});
        smn.emplace(i);
        smx.emplace(i);
        ans=((i64)ans-(i64)query(1,i,n)*i)%mod;
    }
