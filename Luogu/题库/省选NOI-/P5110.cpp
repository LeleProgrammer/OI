...
const u64 invm=((u128)1<<64)/mod;
const u64 invm2=((u128)1<<64)/32000;
const u64 invm3=((u128)1<<64)/(mod-1);

inline int Mod(u64 a) {
    register u64 x=(u64)(((u128)a*invm)>>64);
    register u64 v=(u64)(a-x*mod);
    v>=mod?v-=mod:0;
    return v;
}

inline int Mod2(u64 a) {
    register u64 x=(u64)(((u128)a*invm2)>>64);
    register u64 v=(u64)(a-x*32000);
    v>=32000?v-=32000:0;
    return v;
}

inline int Mod3(u64 a) {
    register u64 x=(u64)(((u128)a*invm3)>>64);
    register u64 v=(u64)(a-x*(mod-1));
    v>=(mod-1)?v-=(mod-1):0;
    return v;
}
...
struct Matrix {
    ...
    inline friend Matrix operator * (const Matrix& a,const Matrix& b) {
        register Matrix ans;
        ans.a=Mod((i64)a.a*b.a+(i64)a.b*b.c);
        ans.b=Mod((i64)a.a*b.b+(i64)a.b*b.d);
        ans.c=Mod((i64)a.c*b.a+(i64)a.d*b.c);
        ans.d=Mod((i64)a.c*b.b+(i64)a.d*b.d);
        return ans;
    }
} G,p[N],q[N],A;
...
inline void init() {
    ...
    // p[0]
    p[0].a=1,p[0].d=1;
    _rep(i,1,32000) p[i]=p[i-1]*G;
    auto G2=p[32000];
    // q[0]
    q[0]=p[0],q[1]=G2;
    _rep(i,2,32000) q[i]=q[i-1]*G2;
}
...
inline Matrix gsm(u64 n) {
    n=Mod3(n);
    register int k=n/32000;
    return q[k]*p[Mod2(n)];
}

inline int query(u64 n) {
    if (!n) return 0;
    else if (n==1) return 1;
    n--;
    register auto res=A*gsm(n);
    return res.b;
}
