...
i32 main() {
    ...
    while (T--) {
        ...
        int l=1,r=n;
        while (l<r) {
            if (a[l]==a[r]) b[l]=b[r]=0;
            else if (a[l]<a[r]) b[l]=a[r]-a[l],b[r]=m-b[l];
            else b[r]=a[l]-a[r],b[l]=m-b[r];
            l++,r--;
        }
        l--,r++;
        int L=l+1,R=r-1;
        ...
        while (l>=1) {
            int lc;
            if (L==l+1) lc=max(0LL,b[l]-lcnt);
            else lc=b[l];
            int rc;
            if (R==r-1) rc=max(0LL,b[r]-rcnt);
            else rc=b[r];
            if (lc<=rc) {
                ans+=lc;
                L=l;
