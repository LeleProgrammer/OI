...
struct Splay {
    ...
    void init(int p,int v,int t) {
        this->p=p,this->v=v,this->t=t,sz=1;
    }
} tr[N];

void pushup(int u) {
    tr[u].sz=tr[tr[u].s[0]].sz+tr[tr[u].s[1]].sz+1;
    tr[u].max=max(tr[tr[u].s[0]].max,max(tr[tr[u].s[1]].max,tr[u].v));
    tr[u].cnt0=tr[tr[u].s[0]].cnt0+tr[tr[u].s[1]].cnt0+(tr[u].t==0);
    tr[u].cnt1=tr[tr[u].s[0]].cnt1+tr[tr[u].s[1]].cnt1+(tr[u].t==1);
}

void pushdown(int u) {
    if (tr[u].cle) {
        tr[tr[u].s[0]].cle=true;
        tr[tr[u].s[1]].cle=true;
        tr[tr[u].s[0]].v=0;
        tr[tr[u].s[1]].v=0;
        tr[tr[u].s[0]].max=0;
        tr[tr[u].s[1]].max=0;
    ...
    if (tr[u].rev) {
        swap(tr[tr[u].s[0]].cnt0,tr[tr[u].s[0]].cnt1);
        swap(tr[tr[u].s[1]].cnt0,tr[tr[u].s[1]].cnt1);
    ...
    if (tr[u].add) {
        ...
        tr[tr[u].s[0]].v+=tr[u].add*(tr[tr[u].s[0]].t==0);
        tr[tr[u].s[0]].max+=tr[u].add*(tr[tr[u].s[0]].cnt0!=0);
        tr[tr[u].s[1]].add+=tr[u].add;
        tr[tr[u].s[1]].v+=tr[u].add*(tr[tr[u].s[1]].t==0);
        tr[tr[u].s[1]].max+=tr[u].add*(tr[tr[u].s[1]].cnt0!=0);
        tr[u].add=0;
    }
}
