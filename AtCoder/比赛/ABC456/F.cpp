...
struct val {
    int l,r;
    int g00,g01,g10,g11;
    val(): l(0),r(0),g00(0),g01(0),g10(0),g11(0) {}
};

inline void pushup(val& u,val& l,val& r) {
    u.g00=max3(l.g00+r.g00,l.g01+r.g00,l.g00+r.g10);
    u.g11=max3(l.g10+r.g01,l.g10+r.g11,l.g11+r.g01);
    u.g01=max3(l.g00+r.g01,l.g00+r.g11,l.g01+r.g01);
    u.g10=max3(l.g10+r.g00,l.g10+r.g10,l.g11+r.g00);
}
...
i32 main() {
    ...
    while (T--) {
        ...
        _rep(i,1,n) seg.modify(1,i,i,a[i]);
        int ans=inf;
        _rep(len,k,min(k+2,n)) _rep(i,1,n-len+1) {
            int g;
            if (i+1<=i+len-2) {
                auto t=seg.query(1,i+1,i+len-2);
                g=max4(t.g00,t.g01,t.g10,t.g11);
                // cout<<"test: "<<i+1<<" "<<i+len<<" "<<g<<endl;
            } else g=0;
            chmin(ans,p[i+len-1]-p[i-1]-g);
        }
        writeln(ans);
    }
    return 0;
